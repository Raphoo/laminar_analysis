function lfp = Unitdata_To_Fieldtrip(lfp,unitdata,view_flag)
...
[dn,~] = binspikes(spk,1000,[0 max(maxs)]); dn = dn'; dn(dn>1) = 1;
...
cfg=[]; cfg.channel = lfp.label((nLfpCh+1):end); lfp = ft_preprocessing(cfg,lfp);
