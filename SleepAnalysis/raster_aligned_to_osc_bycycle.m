function [avglfp,rast_singtrial,rast_avgmean,rast_avgstd] = raster_aligned_to_osc_bycycle(unitdata,tc,st,trgh_times,fs)
%win in seconds
...
trldf = zeros(length(trgh_inds),3); trldf(:,1) = trgh_inds-500; trldf(:,2) = trgh_inds+500;
