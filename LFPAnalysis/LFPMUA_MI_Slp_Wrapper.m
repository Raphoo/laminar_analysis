...
for sessf = 1 : 6%length(sess_folders)
    ...
    [PACa, PACza, ModInda, ModIndZa] = LFPMUA_MI(lfp,mua,nPrm,time_STATE2gs(states(1).t));
    ...
    save('SlpLFPMiRes.mat','PACa', 'PACza', 'ModInda', 'ModIndZa', '-v7.3')
...
save('SlpPACResults_DualLam.mat','PACaa','PACzaa','ModIndaa','ModIndZaa','-v7.3')